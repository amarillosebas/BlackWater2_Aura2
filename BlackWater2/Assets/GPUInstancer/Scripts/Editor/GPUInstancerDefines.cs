...
#if UNITY_2018_1_OR_NEWER
        public static void LoadPackageDefinitions()
        {
            if (!GPUInstancerConstants.gpuiSettings.packagesLoaded)
            {
            ...
            try
            {
                if (_packageListRequest != null)
                {
                    ...
                    if (_packageListRequest.Result != null)
                    {
                        ...
                        if (!GPUInstancerConstants.gpuiSettings.isHDRP && !GPUInstancerConstants.gpuiSettings.isLWRP)
